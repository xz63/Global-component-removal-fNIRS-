...
This implementation is actually a spatial gaussian convolution algorithm while the distance between two points (channels) is defined as the great circle arclength around the head. In this version,
both the principal component analysis and a special matlab toolbox requirement are removed and replaced with code with equal function.
